...
TTTECH_DIR = "tsn_sw_base.sysrepo-plugins/ieee802-dot1q-fqtss-yang-module"
...
do_install:append () {
    ...
    install -m 0644 ${S}/../YANG_modules_repository/ieee802-dot1q-fqtss.yang ${D}/etc/netopeer2/yang
